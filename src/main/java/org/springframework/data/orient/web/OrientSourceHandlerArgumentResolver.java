package org.springframework.data.orient.web;
...
public class OrientSourceHandlerArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     * Returns the name of the request parameter to find the {@link org.springframework.data.orient.repository.OrientSource} information in.
     *
